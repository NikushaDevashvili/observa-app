          ...
          <div style={styles.contentInner}>
            ...
            >
              <p style={styles.paragraph}>
                Welcome to Observa! This guide will help you get started with AI
                observability in just a few minutes.
              </p>
              <p style={styles.paragraph}>
                Observa provides enterprise-grade observability for your AI
                applications, allowing you to track, monitor, and optimize your
                AI workflows with ease.
              </p>
            ...
            >
              ...
              <CodeBlock language="bash">npm install observa-sdk</CodeBlock>
              <p style={styles.paragraph}>Or with yarn:</p>
              <CodeBlock language="bash">yarn add observa-sdk</CodeBlock>
              <p style={styles.paragraph}>Or with pnpm:</p>
              <CodeBlock language="bash">pnpm add observa-sdk</CodeBlock>
            </Section>
...
const observa = init({
  ...
  projectId: 'your-project-id',
              ...
              <div style={styles.warningBox}>
                <strong>⚠️ Keep your API key secure:</strong> Never commit your
                API key to version control. Use environment variables instead.
              </div>
              <CodeBlock language="typescript">
...
const observa = init({
  apiKey: process.env.OBSERVA_API_KEY!,
            ...
            >
              <p style={styles.paragraph}>
                Track AI interactions and monitor performance. The{" "}
                <code style={styles.inlineCode}>track</code> method wraps your
                AI calls and automatically captures metrics.
              </p>
              ...
              <table style={styles.table}>
                ...
                <tbody>
                  <tr>
                    ...
                    <td style={styles.tableCell}>
                      Event object containing query, model, provider, and
                      optional metadata
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td style={styles.tableCell}>
                      Function that performs the AI API call
                    </td>
                  </tr>
                </tbody>
              </table>
      ...
      return response.json()
            ...
            >
              <ul style={styles.list}>
                <li>
                  <strong>Use environment variables:</strong> Never hardcode API
                  keys in your source code.
                </li>
                <li>
                  <strong>Include meaningful metadata:</strong> Add context like
                  userId, sessionId, and feature flags to help with debugging.
                </li>
                <li>
                  <strong>Handle errors gracefully:</strong> Wrap tracking calls
                  in try-catch blocks to prevent observability from breaking
                  your application.
                </li>
                <li>
                  <strong>Use appropriate environments:</strong> Set the
                  environment field to differentiate between development,
                  staging, and production.
                </li>
                <li>
                  <strong>Monitor performance:</strong> Review your tracked
                  events regularly to identify bottlenecks and optimization
                  opportunities.
                </li>
              </ul>
              <CodeBlock language="typescript">
  ...
  environment: process.env.NODE_ENV || 'development',
            ...
            >
              ...
              <div style={styles.faqItem}>
                ...
                <p style={styles.paragraph}>
                  Check that your API key is correct and that you're using the
                  correct tenant and project IDs. Verify network connectivity
              ...
              <div style={styles.faqItem}>
                ...
                <p style={styles.paragraph}>
                  Ensure your API key is valid and properly set in environment
                  variables. Check the format of your initialization options.
                </p>
              </div>
              ...
              <div style={styles.faqItem}>
                ...
                <p style={styles.paragraph}>
                  The SDK is designed to be non-blocking and lightweight. If you
                  experience performance issues, check that you're not wrapping
                  synchronous operations or blocking calls unnecessarily.
                </p>
              </div>

              <h3 style={styles.h3}>Getting Help</h3>
              <p style={styles.paragraph}>
                If you're still experiencing issues, reach out to our support
                team or check our{" "}
                <a
                  href="https://github.com/your-org/observa-sdk/issues"
                  style={styles.link}
                  target="_blank"
